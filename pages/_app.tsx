...
function MyApp({ Component, pageProps }) {
    return (
        <div className="grid grid-cols-12 gap-6 px-5 my-14 lg:mb-0 md:mb-16 sm:px-20 md:px-32 lg:px-36 xl:px-48 ">
            ...
            <div className="flex flex-col overflow-hidden bg-white col-span-14 shadow-custom-light dark:shadow-custom-dark rounded-2xl lg:col-span-9 dark:bg-dark-500">
                ola comotas
                <Component {...pageProps} />
            </div>
